...
async function getEventos(){
    try {
        ...
        /*8° - Asigno a la variable currentData la fecha indicada en DataApi*/
        currentData = new Date(dataAPI.currentDate);
        
        /*9° - Completo el array de eventos posteriores a la fecha contenida en 
        currentDate con los datos obtenidos del API*/
        ...
        /*14° Extraemos del array de eventos las categorias de los eventos, usando 
        una funcion*/
        categorias = extractCategory(eventos);

        /*16° Llamo a una funcion que me cree el HTML de los checkboxes*/
